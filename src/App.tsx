...
export default function App() {
  ...
  return (
    <div className="bg-[#0A0A0B] min-h-screen text-slate-300 selection:bg-brand-500 selection:text-slate-950">
      {/* Dynamic Navigation Banner */}
      <Header />

      {/* Hero Showcase Frame */}
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden bg-[#0E0E11] border-b border-white/5">
        {/* Subtle grid pattern background */}
        <div className="absolute inset-0 z-0 bg-[linear-gradient(to_right,#fff_0.02rem,transparent_0.02rem),linear-gradient(to_bottom,#fff_0.02rem,transparent_0.02rem)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-[0.03] pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-11 xl:col-span-7 space-y-6">
              <motion.div
                ...
                className="space-y-4"
              >
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded bg-brand-500/10 text-brand-400 text-xs font-semibold tracking-tight border border-brand-500/20">
                ...
                <p className="font-sans text-slate-400 text-sm md:text-base max-w-xl leading-relaxed">
                  Hi, I’m <strong className="text-white font-semibold">Daniel Bassey</strong>. I specialize in building serverless data pipelines, 
                  deploying optimized cloud databases, and compiling executive business dashboards that 
                  reveal critical operational trends.
                </p>
              </motion.div>
              ...
              <motion.div
                ...
                className="flex flex-wrap gap-4 pt-2 text-slate-300 text-xs font-semibold font-mono"
              >
                <div className="flex items-center gap-2 px-3.5 py-2 bg-[#141419] border border-white/5 rounded shadow-sm">
                  <span className="p-1 bg-brand-500/10 text-brand-400 rounded"><Database className="h-3.5 w-3.5" /></span>
                  Data Analyst
                </div>
                <div className="flex items-center gap-2 px-3.5 py-2 bg-[#141419] border border-white/5 rounded shadow-sm">
                  <span className="p-1 bg-brand-500/10 text-brand-400 rounded"><Cloud className="h-3.5 w-3.5" /></span>
                  Cloud Data Analyst
                </div>
                <div className="flex items-center gap-2 px-3.5 py-2 bg-[#141419] border border-white/5 rounded shadow-sm">
                  <span className="p-1 bg-brand-500/10 text-brand-400 rounded"><TrendingUp className="h-3.5 w-3.5" /></span>
                  Business Analyst
                </div>
              </motion.div>
              ...
              >
                <a
                  href="#sandbox"
                  className="px-5 py-3 rounded bg-brand-500 border border-brand-500 text-slate-950 font-bold text-xs uppercase tracking-wider hover:bg-brand-400 transition active:scale-[0.98] cursor-pointer"
                >
                  Explore Interactive Sandbox
                </a>
                <a
                  href="#contact"
                  className="px-5 py-3 rounded bg-white/5 border border-white/10 text-slate-300 font-bold text-xs uppercase tracking-wider hover:bg-white/10 hover:text-white transition active:scale-[0.98] cursor-pointer"
                >
                  Get In Touch
                </a>
              </motion.div>
            ...
            <div className="lg:col-span-11 xl:col-span-5 relative mt-6 lg:mt-0">
              <motion.div
                ...
                className="relative bg-[#141419] rounded-lg p-6 text-white border border-white/5 shadow-2xl space-y-5"
              >
                {/* Floating Status Indicator */}
                <div className="absolute top-4 right-4 text-[10px] uppercase font-bold tracking-widest text-slate-500 font-mono flex items-center gap-1.5 z-10">
                ...
                <div className="space-y-1">
                  <h3 className="font-display font-medium text-lg uppercase tracking-wider">
                ...
                <div className="flex bg-[#0A0A0B] p-1 rounded border border-white/5 shrink-0 z-20 relative">
                  <button
                  ...
                  {activeHeroTab === 'outcomes' ? (
                    ...
                    >
                      <div className="flex justify-between items-center py-2">
                        <div>
                          <h4 className="text-[10px] text-slate-550 font-mono font-bold uppercase tracking-wider">Operational Flow</h4>
                          <p className="text-sm font-semibold text-white mt-0.5">Streamlined overall structures</p>
                        </div>
                        <span className="text-lg font-display font-bold text-emerald-400 bg-emerald-950/30 px-2.5 py-1 rounded border border-emerald-500/20">
                          +20%
                        </span>
                      </div>
                      ...
                      <div className="flex justify-between items-center py-2.5">
                        <div>
                          <h4 className="text-[10px] text-slate-550 font-mono font-bold uppercase tracking-wider">Stakeholder Engagement</h4>
                      ...
                      <div className="flex justify-between items-center py-2.5">
                        <div>
                          <h4 className="text-[10px] text-slate-550 font-mono font-bold uppercase tracking-wider">Research Match Rate</h4>
                    ...
                    <motion.div
                      ...
                      initial={{ opacity: 0, y: 5 }}
                      animate={{ opacity: 1, y: 0 }}
                      className="space-y-4 text-slate-350 pt-2"
                    >
                      {/* LinkedIn Header Badge */}
                      <div className="flex items-center gap-3 bg-[#0A0A0B]/60 p-3 rounded-lg border border-white/5">
                      ...
                      <div className="space-y-2 text-xs">
                        <div className="flex items-start gap-2">
                          ...
                          <p className="text-slate-300"><strong className="text-white">Experience Scope:</strong> Active roles at <span className="text-brand-400">Incrosoft</span> (Lead BA), <span className="text-brand-400">Deloitte</span> (Data Analyst), and <span className="text-brand-400">Chitt Organization</span> (Research Analyst).</p>
                        </div>
                        <div className="flex items-start gap-2">
                          <span className="h-1.5 w-1.5 rounded-full bg-brand-500 mt-1.5 shrink-0" />
                        ...
                        <div className="flex items-start gap-2">
                          <span className="h-1.5 w-1.5 rounded-full bg-brand-500 mt-1.5 shrink-0" />
                          <p className="text-slate-290"><strong className="text-white font-semibold text-slate-200">Endorsed Specialties:</strong> Database design (MS SQL Server), serverless AWS (Athena/S3), dashboarding (Looker Studio), and Python statistics.</p>
                        </div>
                      </div>
                      ...
                      <div className="pt-1">
                        <a 
                          ...
                          className="w-full py-2 px-3 bg-[#0077b5] border border-[#0077b5]/30 text-white hover:bg-[#006297] rounded text-xs font-bold transition flex items-center justify-center gap-1.5 cursor-pointer select-none shadow-lg shadow-[#0077b5]/10"
                        >
                          <Linkedin className="h-3.5 w-3.5" />
      ...
      <section id="sandbox" className="py-20 max-w-7xl mx-auto px-4 md:px-8">
        <div className="space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            <span className="text-xs font-bold text-brand-500 tracking-widest font-mono uppercase">
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="bg-[#141419] rounded-lg border border-white/5 shadow-2xl p-6 md:p-8 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          {/* Emblem column */}
          <div className="md:col-span-4 flex flex-col items-center justify-center text-center p-6 bg-[#0E0E11] rounded border border-white/5 gap-3">
            <div className="p-3 bg-brand-500/10 text-brand-500 rounded border border-brand-500/20 shadow-sm">
      ...
      <section id="contact" className="py-20 bg-[#0E0E11] border-t border-white/5 text-white relative">
      ...
      <footer className="bg-[#0A0A0B] text-slate-500 py-12 border-t border-white/5 text-xs font-mono">
